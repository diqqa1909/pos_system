                  ...
                  <form method="POST" action="{{url('admin/supplier/add')}}">
                    ...
                    <div class="card-body">
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" name="address" id="address" type="text" placeholder="Supplier Address" required></textarea>
                        </div>
                      </div>
                      <div class="row mb-3">
                        <label for="tel" class="col-sm-2 col-form-label">Telephone</label>
                        <div class="col-sm-10">
                          <input type="number" name="tel" class="form-control" id="tel" placeholder="Supplier Phone" required/>
                        </div>
                      </div>
                    </div>
                    <div class="card-footer ">
                      <button type="submit" class="btn btn-primary">Add</button>
                      <a href="/admin/supplier" class="btn btn-secondary float-end">Cancel</a>
                    </div>
                  </form>
                </div>
                </div>
